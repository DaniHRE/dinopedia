...
class Dinosaur(models.Model):
    ...
    height = models.FloatField(max_length=255, blank=False, null=False)
    length = models.FloatField(max_length=255, blank=False, null=False)
    weight = models.FloatField(max_length=255, blank=False, null=False)
